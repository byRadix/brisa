/*
  # Initial schema setup for Briisa.app

  1. New Tables
    - `profiles`: User profiles with freelancer details
    - `listings`: Marketplace listings/ads
    - `ratings`: Ratings and reviews for freelancers
    - `portfolio_items`: Portfolio items for freelancer profiles
